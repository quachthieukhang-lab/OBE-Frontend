                                ...
                                <ResponsiveContainer>
                                    <BarChart data={ploBarData} margin={{ top: 16, right: 16, left: 0, bottom: 8 }}>
                                        ...
                                        <Bar
                                            ...
                                            radius={[6, 6, 0, 0]}
                                        >
                                            {ploBarData.map((entry, index) => {
                                                // Logic tô màu:
                                                // Đạt KPI -> Xanh
                                                // Dưới KPI nhưng trên ngưỡng cá nhân -> Cam
                                                // Dưới cả ngưỡng cá nhân -> Đỏ
                                                const color =
                                                    entry.passRatePercent >= kpiLopHoc * 100
                                                        ? SUCCESS_COLOR
                                                        : entry.passRatePercent >= nguongDatCaNhan * 100
                                                            ? WARNING_COLOR
                                                            : DANGER_COLOR;
