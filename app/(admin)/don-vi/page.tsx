...
export default function DonViPage() {
    ...
    const columns: ColumnsType<DonVi> = [
        ...
        { title: "SĐT", dataIndex: "soDienThoai", width: 120, render: (v) => v ?? "-" },
        { title: "Địa chỉ", dataIndex: "diaChi", width: 200, render: (v) => v ?? "-" },
        { title: "Website", dataIndex: "website", width: 200, render: (v) => v ?? "-" },
        {
            title: "Active",
            dataIndex: "isActive",
